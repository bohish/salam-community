...
const Pitch = ({ slots, chem, onSlotClick, onSlotClear, activeSlotId }: Props) => (
  <div className="relative w-full max-w-2xl mx-auto aspect-[3/4] sm:aspect-[2/3] scroll-mt-24">
    {/* Field background (clipped to rounded shape) */}
    <div className="absolute inset-0 rounded-3xl overflow-hidden border border-primary/25 shadow-[0_20px_60px_-20px_hsl(var(--primary)/0.5)]">
    ...
    {/* Slots layer (not clipped, so cards near top/bottom stay fully visible) */}
